...
const int GAS_CROCIERA_us      = 1450;

// VELOCITÀ (in km/h, non km — nomi corretti rispetto all'originale)
const float MAX_AIRSPEED_X8_kmh      = 45.0f;
const float VELOCITA_STALLO_X8_kmh   = 20.0f;
const float MARGINE_ISTERESI_kmh     = 5.0f;

const float SOGLIA_VELOCITA_DECOLLO_ms = 5.0f;   // m/s, soglia airspeed (Pitot) per considerare il drone "in volo"
